...
import { termsMetadataCopy } from "../../../lib/public-page-metadata";
...
// page body (below) already renders `TERMS_COPY[locale]`.
export async function generateMetadata({ params }: { params: Promise<{ locale: string }> }): Promise<Metadata> {
  const locale = parsePublicLocale((await params).locale);
  return { ...termsMetadataCopy(locale), ...canonicalMetadata("/terms") };
}
